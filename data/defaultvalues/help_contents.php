...
return array (
  ...
  array (
    ...
    'title_stringid' => 0,
    'body' => '<p><strong>"E-mail cím</strong>": A meghívandó felhasználó e-mail címe. A mező kitöltése kötelező.</p><p><strong>"Jogosultságok":</strong> a jelölőnégyzetek segítségével  különböző jogokkal ruházhatja fel a meghívandó felhasználót (több jogosultság is választható):</p><ul><li><strong>Szerkesztő:</strong> Képes szerkeszteni/törölni a portálhoz tartozó összes felhasználó felvételeit, csatornákat hozhat létre, hírt vehet fel.</li><li><strong>Kliens adminsztátor:</strong> Portál adminisztrátor. Felhasználókat hívhat meg, jogosultságaikat kezelheti. Felhasználói csoportokat, illetve szervezeti egységeket hozhat létre. Szerkesztheti a kategória- és műfaj-rendszert.</li><li><strong>Feltöltő:</strong> Felvételeket tölthet fel a portálra, illetve szerkesztheti saját felvételeit.</li><li><strong>Live adminisztrátor:</strong> Élő közvetítéseket hozhat létre és menedzselhet, valamint moderálhatja a felhasználók hozzászólásait (chat).</li></ul><p>A <strong>"Szervezeti egységek"</strong> és a <strong>"Csoportok"</strong> menüponban a meghívandó felhasználót hozzárendelheti az előre létrehozott  szervezeti egységekhez vagy csoportokhoz, egyszerre több elem is választható. A felvételek,  illetve élő közvetítések elérhetőségét később, csoportok és szervezeti  egységek szerint korlátozhatja.</p><p>A <strong>"Felhasználó érvényességi idejének korlátozása"</strong> funkcióval a meghívandó felhasználó csak az itt megadott dátumig lesz képes a portálra bejelentkezni, ezt követően a fiók érvényességét veszti. Az <strong>igen</strong> opció kiválasztásakor megjelenő beviteli mezővel az érvényesség végdátuma adható meg. Az alsó gyorsválasztó segítségével havi, negyedéves, féléves és éves érvényességi időt jelölhet ki.</p>',
    'bodyen' => '',
    'body_stringid' => 0,
  ),
  3 => 
  ...
  array (
    ...
    'title_stringid' => 0,
    'body' => '<p>Felvételeihez hagyományos <strong>.srt</strong> formátumú feliratfájlokat is feltölthet.</p><p>A felirat nyelvét a lenyíló menüből választhatja ki, az <em><strong>"Alapértelmezett felirat"</strong></em> engedélyezésével pedig az adott felirat automatikusan megjelenik a lejátszás elindításakor.</p><p><span style="font-family: Arial, sans-serif;">A felvételekhez egyszerre több feliratot is feltölthet, ezek a videó alatti listában fognak megjelenni és a </span><strong><em style="font-family: Arial, sans-serif;">"törlés"</em></strong> funkcióra kattintva törölhetőek</p>',
    'bodyen' => '<p>You can upload <strong>.srt</strong> format subtitles to the recording.</p><p>Choose subtitle language from the dropdown list. By enabling <em><strong>"default subtitle"</strong></em> option this particular subtitle will be the default one and will be shown when playback is started.</p><p>More than one subtitle can be uploaded to each recording that will be listed under uploaded media items. Remove them any time by clicking "delete" option.</p>',
    'body_stringid' => 0,
  ),
  8 => 
  array (
    ...
    'title_stringid' => 0,
    'body' => '<p>A felvétele mellé bármilyen típusú- és számú dokumentumot feltölthet, amelyek a fenti listában jelennek meg. Kattintson a <em><strong>"tallózás"</strong></em> gombra, adja meg a fájl helyét, adjon egy címet a csatolmánynak, és kattintson az <em>"Ok"</em>-ra a feltöltés megkezdéséhez.</p><p>A csatolmány letöltő linkje csak akkor jelenik meg a felhasználók számára, ha a <strong><em>"Dokumentum elérhető"</em></strong> értéke <em>"igen"</em>-re van állítva.</p>',
    'bodyen' => '',
    'body_stringid' => 0,
  ),
  9 => 
  array (
    ...
    'title_stringid' => 0,
    'body' => '<p>Az <strong>"Állomány kiválasztása"</strong> gombra kattintva válassza ki a feltölteni kívánt tartalom videót! Kérjük, figyelmesen olvassa el a <strong>"Felhasználási feltételek"</strong> oldalt, majd amennyiben elfogadja a tartalmát, hagyja jóvá a dokumentumot! A feltöltést a <strong>"Feltöltés kezdése"</strong> gomb megnyomásával indíthatja el.</p><p>Amennyiben rendelkezik <strong>HTML5</strong> böngészővel, használja a  "fogd és vidd" (drag and drop) módszert! A fájlkezelő alkalmazásban  válassza ki a feltölteni kívánt állományokat, majd dobja őket erre a  lapra! Modern, HTML5 képes böngésző esetén egyszerre több állományt is  feltölthet, valamint megszakadt feltöltéseit 1 héten át megőrizzük  Önnek, így bármikor folytathatja azokat.</p>',
    'bodyen' => '',
    'body_stringid' => 0,
  ),
  10 => 
