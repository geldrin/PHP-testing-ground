...
CREATE TABLE `users` (
   ...
   `issingleloginenforced` int(11) unsigned not null default '0',
   `ispresencecheckforced` int(11) unsigned not null default '0',
   `sessionid` char(32),
...
CREATE TABLE `organizations` (
   ...
   `presencechecktimeinterval` int(11) unsigned not null default '1800',
...
CREATE TABLE `recordings` (
  ...
  `visibleuntil` datetime default null,
  `indexphotofilename` text,
  `numberofindexphotos` int(10) unsigned default '0',
  ...
  `ratingthisweek` decimal(3,2) not null default '0.00',
  `sumofratingthisweek` bigint(20) unsigned not null default '0',
  `numberofratingsthismonth` bigint(20) unsigned not null default '0',
  `ratingthismonth` decimal(3,2) not null default '0.00',
  `sumofratingthismonth` bigint(20) unsigned not null default '0',
  `masterdatasize` bigint(20) unsigned default null,
  `recordingdatasize` bigint(20) unsigned default null,
  `mastervideofilename` text,
  `mastervideoextension` text,
  `mastermediatype` text,
  `mastervideostreamselected` int(11) default null,
  `mastervideoisinterlaced` int(11) default '0',
  ...
  `masteraudiostreamselected` int(11) default null,
  ...
  `contentmastervideoisinterlaced` int(11) default '0',
  `contentmastervideofilename` text,
  `contentmastervideoextension` text,
  `contentmastermediatype` text,
  `contentmastervideostreamselected` int(11) default null,
  ...
  `contentmasteraudiostreamselected` int(11) default null,
  ...
  `offsetstart` int(11) default null,
  `offsetend` int(11) default null,
  `contentoffsetstart` int(11) default null,
  `contentoffsetend` int(11) default null,
  `mobilestatus` text,
  ...
  `introrecordingid` int(10) unsigned default null,
  `outrorecordingid` int(10) unsigned default null,
  `deletedtimestamp` datetime default null,
  `contentdeletedtimestamp` datetime default null,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;
...
CREATE TABLE `categories` (
   ...
   `name_stringid` int(10) unsigned not null,
   `namehyphenated` text,
   `namehyphenated_stringid` int(10) unsigned default null,
   `iconfilename` text,
...
CREATE TABLE `roles` (
   ...
   `ispresenter` int(11) not null default '0',
   `organizationid` int(10) unsigned not null,
   PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;
...
CREATE TABLE `livefeed_streams` (
   ...
   `status` text,
   `recordinglinkid` int(10) unsigned default null,
