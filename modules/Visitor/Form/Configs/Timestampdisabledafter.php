...
$config['timestampdisabledafter'] = array(
  ...
  ,
  'postfix'     => '
    <br/><span class="timestampdisabledafter"><a href="#" class="presettime" data-date="' . date('Y-m-d 23:59', strtotime('+1 months') ) . '">' . $l('users', 'disable_month') . '</a> |
    ...
    <a href="#" class="presettime" data-date="' . date('Y-m-d 23:59', strtotime('+1 year') ) . '">' . $l('users', 'disable_year') . '</a></span>
  ',
  'validation'  => array(
    array(
      'type'     => 'date',
