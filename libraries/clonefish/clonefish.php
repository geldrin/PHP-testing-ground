...
class clonefish {
  ...
  function getValidationJSCode() {
    ...
    return
      "<!--\n" .
      "\n" .
      "function check_" . $this->name . "( data, elementname, elementid ) {\n" .
      "\n" .
      ...
      // show AJAX validation messages when AJAX is on
      ( strlen( $ajaxcode ) ?
      "  // AJAX results\n" .
      "  if ( ( typeof( data ) == 'object' ) && data[ elementname ] ) {\n" .
      "    if ( data[ elementname ].error ) {\n" .
      "      errors.add( elementid, data[ elementname ].error );\n" .
      "      errors.go();\n" .
      "      return false;\n" .
      "    } else if ( data[ elementname ].success )\n" .
      "      return true;\n" .
      "  }\n" .
      "\n"
      : "" ) .
