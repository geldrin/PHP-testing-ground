...
<div class="sort">
  <div class="item">
    <a href="{$url|replace:'%s':relevancy}">{#search__all_relevancy#|sortarrows:null:relevancy:$order}</a>
  </div>
  
  <div class="item">
    <a href="{$url|replace:'%s':recordedtimestamp}">{#search__recordedtimestamp#|sortarrows:null:recordedtimestamp:$order}</a>
    <ul>
